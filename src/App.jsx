...
export default function App() {
  ...
  const routers = createBrowserRouter([{
    path: "/Game-Over", element: <MainLayOut use={use} logout={logout}  />, children: [
      { index:true, element: <Login usedata={usedata} /> },
      { path: "/Game-Over/Register", element: <Register /> },


      {
        path: "/Game-Over/Details/:id", element:
    ...
    {path:"/",element:<LayOut use={use} logout={logout} />,children:[
      {
